...
if page == "Edit Room":
    ...
    with st.expander(f'a.n. {nama_lama}'):
        with st.form(f'data-{id}'):
            ...
            default_series_room = series_room_lama if series_room_lama in list_room else None
            series_room_baru = st.selectbox("series_room", list_room, index=list_room.index(default_series_room)) 
